...
class OpenAIGateway:
    ...
    async def rewrite_offer(self, original_text: str) -> str:
        prompt = f"""
            ...
            Сохрани факты, цену, условия, контакты по смыслу. 
            ...
            ФОРМАТ ОТВЕТА:
            Если отсутствует какой-то из пунктов, то не включай его в ответ. Итоговый текст напиши по шаблону, можешь добавить несколько эмодзи и смайликов.
            Если итоговый кэшбек для покупателя > 50%, то выдели его жирным и поставь 🔥 
